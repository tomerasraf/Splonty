...
public class CheckGDPRCountry : MonoBehaviour
{
    private static Dictionary<string, string> countryCodesMapping = new Dictionary<string, string>() {
   //{ "Afghanistan", "93" },
   //{ "Åland Islands", "358" },
   //{ "Albania", "355" },
   //{ "Algeria", "213" },
   ...
   //{ "Zimbabwe", "263" },
    ...
    public static bool CheckCountryForGDPR()
    {
